...
# Merhaba `r emo::ji("wave")`

- **Emrah Er**

- **Ar. Gör.**, _Ankara Üniversitesi SBF_

- **Doktora**, _Kansas State University_
   
# Veri İndirme

* [USGS](https://earthquake.usgs.gov/fdsnws/event/1/#format-geojson)
...
countries <- c("Indonesia", "Japan", "Philippines", "Papua New Guinea", 
               "Alaska", "Chile", "Tonga", "Greece", "Vanuatu", "Russia")
...
tm_shape(spData::world) + 
  ...
  tm_scale_bar(breaks = c(0, 2500, 5000), 
               text.size = 1, 
...
pal <- leaflet::colorFactor(viridis_pal(option = "B")(20), 
                            domain = afad_dt$Magnitude)
...
# Sehir isimleri eslesmiyor. Bunlari duzeltelim. 
...
# Haritayi cizelim
# Haritanin boyutu biraz buyuk. Zaman alabilir. Sabrederseniz images 
# klasorundeki haritayi elde edersiniz.
ggplot(data = map_dt) +
...
docs <- tm_map(docs, 
               removeWords, 
               c("gutenbergtm", "gutenberg", "project", "ebook", 
                 "license", "agreement", "trademark", "terms"))
